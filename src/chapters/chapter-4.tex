...
Kemudian dilakukan prediksi pada data test dari model yang telah dilakukan training sehingga dapat diperoleh nilai loss yang dihasilkan.
    ...
    \subsection{Perbandingan dengan Model Acuan}

    Dari segi kinerja model LSTM dapat menghasilkan hasil yang lebih baik dari model acuan sebanding dengan jumlah epoch yang lebih tinggi, namun waktu learning juga akan menjadi semakin lama. Sedangkan model acuan dapat dijalankan dalam waktu yang singkat (orde detik).

    Model dengan dan tanpa PCA masing-masing menghasilkan prediksi anomali pada data NORMAL sebanyak 21\% dan 19\% dari total data, lebih besar dari model acuan yang paling tinggi menghasilkan 14\%.
